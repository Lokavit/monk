...
const SOURCE_DIR = path.resolve(__dirname, "../../anicca/linux");
const DIST_DIR = path.resolve(__dirname, "../linux");
...
async function build() {
  console.log("🚀 Starting Linux Build with Buddhist Calendar...");
...
<head>
    <meta charset="UTF-8">
    <title>${postData.title} - Linux</title>
    <script> 
        (function() {
...
<body  >
  ...
  console.log("✅ Linux Index Generated (data.json)");
}
