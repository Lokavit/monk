...
const SOURCE_DIR = path.resolve(__dirname, "../../anicca/life");
const DIST_DIR = path.resolve(__dirname, "../life");
...
async function build() {
  console.log("🚀 Starting Life Build with Buddhist Calendar...");
...
<head>
    <meta charset="UTF-8">
    <title>${postData.title} - Life</title>
    <script>
        // 瞬間同步主題色，防止白閃或黑閃
        (function() {
...
<body  >
  ...
  console.log("✅ Life Index Generated (data.json)");
}
