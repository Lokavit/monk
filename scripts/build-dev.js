...
const SOURCE_DIR = path.resolve(__dirname, "../../anicca/dev");
const DIST_DIR = path.resolve(__dirname, "../dev");
...
<head>
    <meta charset="UTF-8">
    <title>${postData.title} - Dev</title>
    <script> 
        (function() {
...
<body  >
  ...
  console.log("✅ Dev Index Generated (data.json)");
}
